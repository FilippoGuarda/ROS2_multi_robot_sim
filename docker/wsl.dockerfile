...
RUN echo "alias rgazebo='ros2 launch aws_robomaker_hospital_world hospital.launch.py input_file:=/home/workspace/install/multi_robot_sim/share/multi_robot_sim/configs/robot_setup_6.json'" >> ~/.bashrc && \
    echo "alias rnav2='ros2 launch multi_robot_sim test_multi_robot_launch.py input_file:=/home/workspace/src/multi_robot_sim/configs/robot_setup_6.json'" >> ~/.bashrc && \
    echo "alias gcostmap=' ros2 launch multi_robot_costmap_plugin multi_robot_costmap_launch.py'" >> ~/.bashrc && \
    echo "alias rsmrta ='ros2 launch multi_robot_sim smrta_multi_robot_launch.py input_file:=/home/workspace/src/multi_robot_sim/configs/robot_setup_6.json'" >> ~/.bashrc 
